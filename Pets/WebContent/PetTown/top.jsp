...
<div class="row" id="topnav">
			<div class="col-xs-offset-1 col-xs-4 logoimg">
				<img src="<c:url value='/PetTown/images/editlogoblack.png'/>" id="logoimgs" /> 
			...
			<div class="col-xs-3" id="icons">
				<a href="<c:url value='/PetTown/home.jsp'/>" target="">
				<span class="glyphicon glyphicon-home" aria-hidden="true"></span> </a>
				<a href="<c:url value='/PetTown/byungjaemap.jsp'/>" target="">
				<span class="glyphicon glyphicon-send" aria-hidden="true"></span> </a>
				<a href="<c:url value='/PetTown/jaeyongmap.jsp'/>" target="">
				<span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> </a>
				<a href="<c:url value='/PetTown/sunggyumap.jsp'/>" target="">
